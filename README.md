...
🧑‍💻 Build: Commits 1-6 hechos (scaffold + Supabase/Auth wiring + subida/validación + lectura con visión + motor de cotejo real + mensaje/acción/evento de valor). Live: **https://cotejo-psi.vercel.app**
